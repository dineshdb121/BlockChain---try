...
import static Blockcain.Block.sha256;
...
/*
        ...
        for (int i = 0; i < blockChain.size() + 1; i++) {
            ...
            System.out.println("From b" + i + " : " + currentHash + " Current BlockHash Code b2 : " + bi.getBlockHash());

            blockChain.add(bi);
            currentHash = blockChain.getLast().getBlockHash();
